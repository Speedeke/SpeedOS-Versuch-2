...
/// Die statische IP-Konfiguration. `gesetzt` unterscheidet „bewusst
/// konfiguriert" von der Null-Vorgabe.
...
/// leer — bis `netz-ip` sie setzt (oder später DHCP).
...
/// Setzt die statische IP-Konfiguration (Shell-Befehl `netz-ip`).
